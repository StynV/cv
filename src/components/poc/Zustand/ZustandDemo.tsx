    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.cart}>
                <h1>Cart</h1>
                <button onClick={() => useCartStore.getState().addItem(newItem)}>Add item</button>
                ...
                <ul className={styles.items}>
                    {items.map(item => (
                        <li key={item.id} className={styles.item}>
                            ...
                            <button className={styles.btn} onClick={() => useCartStore.getState().removeItem(item.id)}>{item.name}</button>
                        </li>
                    ))}
                </ul>
