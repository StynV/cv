...
const FormWithActions = () => {
  ...
  const companiesWithAFWIJZING_NA_GESPREK = GetState(
    StateEnum.AFWIJZING_NA_GESPREK
  )
  const companiesWithTWEEDE_GESPREK_AFWIJZING = GetState(
    StateEnum.TWEEDE_GESPREK_AFWIJZING
  )
  const companiesWithINTERESSE_MAAR_GEEN_WERK = GetState(
    StateEnum.INTERESSE_MAAR_GEEN_WERK
  )
  ...
  return (
    <div className={styles.main}>
      ...
      <p>
        Afwijzing na technisch gesprek: {companiesWithTWEEDE_GESPREK_AFWIJZING}
      </p>
      <p>
        Technisch gesprek goed bevonden, maar bedrijf heeft te weinig werk in
        React: {companiesWithINTERESSE_MAAR_GEEN_WERK}
      </p>
